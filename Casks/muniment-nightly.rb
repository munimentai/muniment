cask "muniment-nightly" do
  ...
  url "https://github.com/mikeydiamonds/homebrew-muniment/releases/download/nightly/nightly-#{version}-macos-muniment.app.zip"
  name "Muniment Nightly"
  desc "Desktop client for Muniment"
  homepage "https://github.com/mikeydiamonds/homebrew-muniment"
