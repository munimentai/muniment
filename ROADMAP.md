...
- NEXT E1 — add typed `run.stream` subscription requests and incremental catch-up event reads to the protocol-only client. Later independent slices add cursor acknowledgements/live tail, terminal rendering, and permission-answer parity.
