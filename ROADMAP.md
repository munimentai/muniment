...
- DONE — ADR 0006, verified revision publication/recovery, bounded resumable acquisition, and the shared native HTTPS/proxy acquisition transport.
- NEXT — shared free-space and cancellable-lock installation orchestration spanning acquisition through publication. Activation-health rollback, Tauri commands, UI, and release notice delivery follow as separate slices.
...
- DONE — ADRs 0004/0005, pinned Parakeet verification, revision publication/recovery, bounded resumable acquisition, and consumption of the shared native HTTPS/proxy transport.
- NEXT — the same shared free-space and cancellable-lock installation orchestration as Gemma. Native bindings/packaging, commands/UI, capture/VAD, and hardware validation follow separately.
