...
- Open items: headless/server CLI stance (owner ruling pending); Gemma 4 E2B is the tracked alternate pending llama.cpp PLE support (ggml-org/llama.cpp#22243); the final model pick is gated on the MUNIQA routing eval. Ripple: MUNICLOUD artifact proxy/redirect for the model download.
