...
- NEXT E1 — have the protocol-only client acknowledge consumed run-stream windows and continue paused catch-up. Later independent slices add live tail, terminal rendering, and permission-answer parity.
