...
- NEXT — system-wide hold-to-talk shortcut foundation. Toggle/double-tap, rebinding, Kokoro read-aloud, and physical target-hardware runs (which require the approved external corpus and representative machines) follow as separate slices.
