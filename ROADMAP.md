...
- NEXT — production VAD selection and lifecycle, desktop recognition command wiring, UI, and target-hardware validation remain as independent slices.
