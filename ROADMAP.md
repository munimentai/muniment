...
- NEXT — wire the confirmed-proposal frontend through that native completion command, including success, conflict recovery, and completion state. CLI/VS Code defaults wait for workspace memory semantics.
