...
- NEXT E1 — expose the existing `run.start` client as one receipt-only interactive CLI command. Later independent slices add run streaming and permission-answer parity.
