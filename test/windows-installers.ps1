...
# NSIS /S is case-sensitive. Run NSIS after every MSI scope and cleanup assertion.
# Silent NSIS uninstall keeps the default install path under the shared HKCU application key.
