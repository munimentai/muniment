...
. (Join-Path $PSScriptRoot "../support/windows-clock.ps1")
...
try {
  ...
  & (Join-Path $repoRoot "test/e2e/support/windows-installed-smoke.ps1") -AppBinary $appBinary -AppLibrary $appLibrary -Diagnostics $raw
