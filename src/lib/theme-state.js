...
export const LIGHT_THEMES = ['paper', 'vellum', 'ledger', 'foolscap', 'parchment', 'manila', 'linen', 'broadsheet', 'daybreak']
export const DARK_THEMES = ['moss', 'vault', 'graphite', 'inkwell', 'lagoon', 'umber', 'fjord', 'plum', 'nocturne', 'nightshade', 'basalt', 'obsidian', 'carbon', 'afterglow']
export const VIBRANT_THEMES = ['daybreak', 'afterglow']
