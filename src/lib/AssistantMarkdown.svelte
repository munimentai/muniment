...
<style>
  .assistant-markdown { max-width: 92%; color: var(--ink); white-space: pre-wrap; overflow-wrap: anywhere; }
  ...
  .assistant-markdown :global(ul), .assistant-markdown :global(ol) { margin: 0 0 12px; padding-left: 24px; }
  ...
  .assistant-markdown :global(a:focus-visible) { outline: 1px solid var(--ink); outline-offset: 2px; }
  .assistant-markdown :global(pre:focus-visible), .assistant-markdown :global(table:focus-visible) { outline: 1px solid var(--ink); outline-offset: 2px; }
