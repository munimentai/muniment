<script>
  ...
  const ALIASES = { 'openai-codex': 'openai', 'claude-bridge': 'anthropic', 'opencode-go': 'opencode', 'qwen-token-plan-individual': 'qwen-token-plan', 'minimax-cn': 'minimax', 'zai-coding-cn': 'zai' }
