...
export const DEDICATED = [
  {
    ...
    name: 'TypeSafe jev',
    model: 'jev-latest',
    note: 'A System One model. It answers a typed choice with a probability over every route, not prose.',
    price: 0.042,
    context: '64K',
  },
]
...
export const POOLED = [
  { id: 'openai/gpt-5.6-nano', family: 'openai', model: 'gpt-5.6-nano', name: 'GPT-5.6 nano', price: 0.05 },
  ...
  { id: 'xai/grok-4.5', family: 'xai', model: 'grok-4.5', name: 'Grok 4.5', price: 2 },
