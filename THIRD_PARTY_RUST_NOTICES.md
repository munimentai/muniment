# Third-party Rust crate notices

This record lists the non-workspace Rust crates pinned in `src-tauri/Cargo.lock`.
The lockfile is the union across desktop targets and surfaces.
A specific installed package may include fewer crates than this record.

Each entry gives the crate name, exact version, and license expression from `cargo metadata`.

- `adler2` 2.0.1 — 0BSD OR MIT OR Apache-2.0
- `aes` 0.8.4 — MIT OR Apache-2.0
- `agent-client-protocol` 2.0.0 — Apache-2.0
- `agent-client-protocol-derive` 2.2.0 — Apache-2.0
...
- `cap-fs-ext` 4.0.3 — Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT
...
- `dioxus-debug-cell` 0.1.1 — MIT/Apache-2.0
...
- `gdk4` 0.11.4 — MIT
- `gdk4-sys` 0.11.4 — MIT
- `gdk4-wayland` 0.11.4 — MIT
- `gdk4-wayland-sys` 0.11.0 — MIT
- `gdk4-x11` 0.11.4 — MIT
- `gdk4-x11-sys` 0.11.0 — MIT
...
- `tauri` 3.0.0-alpha.1 — Apache-2.0 OR MIT
- `tauri-build` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-codegen` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-macros` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin-dialog` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin-fs` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin-global-shortcut` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin-opener` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-plugin-window-state` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-runtime` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-runtime-cef` 3.0.0-alpha.1 — Apache-2.0 OR MIT
- `tauri-utils` 3.0.0-alpha.0 — Apache-2.0 OR MIT
- `tauri-winit` 0.31.0-beta.3 — Apache-2.0
- `tauri-winit-gtk4` 0.31.0-beta.3 — Apache-2.0
- `tauri-winit-x11` 0.31.0-beta.3 — Apache-2.0
...
- `winit-android` 0.31.0-beta.3 — Apache-2.0
- `winit-appkit` 0.31.0-beta.3 — Apache-2.0
- `winit-common` 0.31.0-beta.3 — Apache-2.0
- `winit-core` 0.31.0-beta.3 — Apache-2.0
- `winit-orbital` 0.31.0-beta.3 — Apache-2.0
- `winit-uikit` 0.31.0-beta.3 — Apache-2.0
- `winit-web` 0.31.0-beta.3 — Apache-2.0
- `winit-win32` 0.31.0-beta.3 — Apache-2.0
- `winnow` 0.7.15 — MIT
- `winnow` 1.0.4 — MIT
- `winreg` 0.55.0 — MIT
