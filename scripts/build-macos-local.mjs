...
// The bundler applies CEF entitlements with an ad-hoc signature. The Apple certificate comes from
...
mustRun("build app", process.execPath, [join("scripts", "tauri-cli.mjs"), "build", "--bundles", "app", "--features", "local-runtime"]);
