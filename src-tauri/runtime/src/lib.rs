...
pub use service::{
    ...
    drive_prompt, ensure_home, ensure_native_session, fetch_chat_grant, onboard_workspace,
    open_profile_storage, queue_run_message, rename_thread, resume_run, run_prompt, thread_page,
