...
pub use macos_activation::{
    emit_macos_unified_log, emit_macos_unified_log_with, macos_rollback_pending,
    record_macos_failed_exit, record_macos_orderly_exit, record_macos_start, MacosDiagnosticEvent,
    MacosRollbackMarkerError, MacosStart, MacosStartDecision, MacosUnifiedLog,
    MacosUnifiedLogRecord, MACOS_ROLLBACK_MARKER_NAME, MACOS_RUNTIME_LOG_MAX_BYTES,
