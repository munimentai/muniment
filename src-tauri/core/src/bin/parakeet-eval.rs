...
use muniment_core::asr::validation::{load_manifest, run_cases};
...
fn usage() -> String {
    "usage: parakeet-eval --model-root <ASR lifecycle root> --manifest <corpus.json> --output <report.json> --machine-tier <tier>".into()
}
